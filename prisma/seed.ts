...
async function main() {
  ...
  await prisma.siteConfig.upsert({
    ...
    create: {
      ...
      schedule: JSON.stringify({
        monday: ['09:30-14:00', '17:00-20:00'],
        tuesday: ['09:30-14:00', '17:00-20:00'],
        wednesday: ['09:30-14:00', '17:00-20:00'],
        thursday: ['09:30-14:00', '17:00-20:00'],
        friday: ['09:30-14:00', '17:00-20:00'],
        saturday: ['Cerrado'],
        sunday: ['Cerrado'],
      }),
  ...
  const testimonials = [
    {
      name: 'María Valcárcel',
      initials: 'MV',
      location: 'Móstoles',
      rating: 5,
      content:
        'Llevo yendo ya varios años y no cambio yo a mi Isabel por nada del mundo. Es la única que ha conseguido quitarme los hongos por completo!',
      service: 'hongos-unas',
      isVerified: true,
      source: 'google',
      isFeatured: true,
    ...
    {
      name: 'Miguel Angel Rodriguez Trobo',
      initials: 'MR',
      location: 'Móstoles',
      rating: 5,
      content:
        'Excelente profesional y muy atenta, gracias a ella he descartado una operación que, al menos, por el momento, no era necesaria. Es la podóloga de referencia en nuestra familia.',
      isVerified: true,
      source: 'google',
      isFeatured: true,
      isActive: true,
    },
    {
      ...
      rating: 5,
      content:
        'Muy profesionales. A mi me atendió Cristina e hizo un trabajo perfecto. No me dolió nada y fue superdelicada. Lo recomiendo cien por cien y además muy bien de precio. Ya tengo podologa. Volveré seguro.',
      service: 'quiropodia',
      isVerified: true,
      source: 'google',
      isFeatured: true,
  ...
  const team = [
    {
      name: 'Isabel',
      role: 'Podóloga',
      bio: 'Podóloga con amplia experiencia en el tratamiento integral del pie. Especialista en onicomicosis y tratamientos de hongos.',
    ...
    },
    {
      name: 'Cristina',
      role: 'Podóloga',
      bio: 'Podóloga dedicada al cuidado del pie con un trato cercano y profesional. Especialista en tratamientos delicados y sin dolor.',
      specialties: JSON.stringify([
        'Quiropodia',
